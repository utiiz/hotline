                ...
                children: <Widget>[
                  Transform.translate(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Transform.translate(
                          offset: Offset(0, (1 - imageAnimation.value) * 5),
                          child: Opacity(
                        ...
                        Transform.translate(
                          offset: Offset(0, (1 - titleAnimation.value) * 15),
                          child: Opacity(
                        ...
                        Transform.translate(
                          offset: Offset(0, (1 - textAnimation.value) * 20),
                          child: Opacity(
                        ...
                        Transform.translate(
                          offset: Offset(0, (1 - inputOneAnimation.value) * 25),
                          child: Opacity(
                            opacity: inputOneAnimation.value,
                            child: Input(
                              label: 'Group name...',
                        ...
                        Transform.translate(
                          offset: Offset(0, (1 - inputTwoAnimation.value) * 30),
                          child: Opacity(
                            opacity: inputTwoAnimation.value,
                            child: Opacity(
                              key: _inputKey,
                              opacity: opacity,
                              child: Input(
